...
public final class PatientCreateCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(PatientCreateCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    PatientCreate command = new PatientCreate();
    ...
    if(parameters.containsKey("ssn") && parameters.get("ssn") != null && parameters.get("ssn").get() != null) {
      convertedParameters.put("ssn", parameters.get("ssn").get());
      if(convertedParameters.get("ssn") !=null && !(convertedParameters.get("ssn") instanceof String)) {
        throw new BotCommandException(MESSAGES_GENERIC.getString("generic.UnexpectedTypeReceived","ssn", "String", parameters.get("ssn").get().getClass().getSimpleName()));
      }
    }
    if(convertedParameters.get("ssn") == null) {
      throw new BotCommandException(MESSAGES_GENERIC.getString("generic.validation.notEmpty","ssn"));
    }
    ...
    if(parameters.containsKey("email") && parameters.get("email") != null && parameters.get("email").get() != null) {
      ...
      if(convertedParameters.get("email") !=null && !(convertedParameters.get("email") instanceof String)) {
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("help"),(String)convertedParameters.get("sessionName"),(String)convertedParameters.get("ssn"),(String)convertedParameters.get("family"),(String)convertedParameters.get("given"),(String)convertedParameters.get("birthdate"),(String)convertedParameters.get("street"),(String)convertedParameters.get("city"),(String)convertedParameters.get("state"),(String)convertedParameters.get("postal"),(String)convertedParameters.get("country"),(String)convertedParameters.get("gender"),(String)convertedParameters.get("maritalStatus"),(String)convertedParameters.get("phone"),(String)convertedParameters.get("email")));
