...
public final class BookAppointmentCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(BookAppointmentCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    BookAppointment command = new BookAppointment();
