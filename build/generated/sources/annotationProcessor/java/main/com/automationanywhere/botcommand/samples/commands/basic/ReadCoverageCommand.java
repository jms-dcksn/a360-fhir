...
public final class ReadCoverageCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(ReadCoverageCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    ReadCoverage command = new ReadCoverage();
