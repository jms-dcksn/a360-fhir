...
public final class ReadAllergyCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(ReadAllergyCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    ReadAllergy command = new ReadAllergy();
