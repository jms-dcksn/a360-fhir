...
public final class SearchCoverageCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(SearchCoverageCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    SearchCoverage command = new SearchCoverage();
    ...
    if(parameters.containsKey("beneficiaryId") && parameters.get("beneficiaryId") != null && parameters.get("beneficiaryId").get() != null) {
      convertedParameters.put("beneficiaryId", parameters.get("beneficiaryId").get());
      if(convertedParameters.get("beneficiaryId") !=null && !(convertedParameters.get("beneficiaryId") instanceof String)) {
        throw new BotCommandException(MESSAGES_GENERIC.getString("generic.UnexpectedTypeReceived","beneficiaryId", "String", parameters.get("beneficiaryId").get().getClass().getSimpleName()));
      }
    }

    command.setSessionMap(sessionMap);
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("help"),(String)convertedParameters.get("sessionName"),(String)convertedParameters.get("patientId"),(String)convertedParameters.get("beneficiaryId")));
